...
static constexpr const int TransferTimeout = 30 * 1000;
static constexpr const int PongTimeout     = 60 * 1000;
static constexpr const int PingInterval    = 5 * 1000;
static constexpr const char SeparatorToken = ' ';
